                        ...
                        <form method="POST" action="{{ route('register.post') }}"
                            ...
                            <div class="relative">
                                <select id="role" name="role" required
                                    class="peer h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-rose-600 bg-transparent">
                                ...
                                <label for="role"
                                    class="absolute left-0 -top-3.5 text-gray-600 text-sm">Role</label>
                            </div>

                            <div class="relative">
                                <button type="submit"
                                    class="w-full bg-cyan-500 hover:bg-cyan-600 text-white rounded-md px-4 py-2 transition duration-200">Register</button>
                            </div>
                        </form>
                    </div>
                </div>
